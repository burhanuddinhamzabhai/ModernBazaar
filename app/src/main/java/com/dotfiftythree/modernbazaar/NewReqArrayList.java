...
public class NewReqArrayList {
    int item = 10;
    String buyer, seller, sellerProduct, buyerProduct, date, phone, mail, barterID, buyerProductImage, sellerProductImage;

    public NewReqArrayList(String buyer, String seller, String sellerProduct, String buyerProduct, String date, String phone, String mail, String barterID, String buyerProductImage, String sellerProductImage) {
        this.buyer = buyer;
        this.seller = seller;
